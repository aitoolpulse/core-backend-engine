...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Tiyazo Agent
license: MIT
...
Helper script path: `~/.tiyazo/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.tiyazo/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.tiyazo/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.tiyazo/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
