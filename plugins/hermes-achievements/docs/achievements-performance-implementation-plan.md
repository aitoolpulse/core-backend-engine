...
- Snapshot persisted at `~/.tiyazo/plugins/hermes-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.tiyazo/plugins/hermes-achievements/scan_checkpoint.json`.
