...
Used by ``tiyazo profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``tiyazo_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Tiyazo Agent kanban board.
...
Rules:
  ...
  - Never write "Tiyazo Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_tiyazo_home())
        else:
