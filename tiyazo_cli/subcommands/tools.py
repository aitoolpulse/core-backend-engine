"""``tiyazo tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'tiyazo tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # tiyazo tools list [--platform cli]
    ...
    # tiyazo tools disable <name...> [--platform cli]
    ...
    # tiyazo tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `tiyazo tools` runs after you pick a provider that\n"
