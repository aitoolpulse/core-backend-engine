...
Entry point: ``tiyazo whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``tiyazo_cli/main.py``).
...
Tiyazo gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Tiyazo to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Tiyazo needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Tiyazo gateway in another terminal:")
    print("         tiyazo gateway")
    print()
    ...
    print()
    print("  Docs: https://tiyazo-agent.nousresearch.com/docs/user-guide/")
