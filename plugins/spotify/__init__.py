...
``_check_spotify_available()`` — when the user has not run ``tiyazo auth
spotify``, the tools remain registered (so they appear in ``tiyazo
...
The Spotify auth flow (``tiyazo auth spotify``), CLI plumbing, and docs
