...
_FORCE_SYNC_ENV = "TIYAZO_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.tiyazo") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.tiyazo to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``TIYAZO_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, tiyazo_home: Path | None = None) -> None:
        ...
        # against an uninitialized remote .tiyazo/ directory.
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.tiyazo/skills/a.md`` →
        ``~/.tiyazo/skills/a.md``, a new remote file at
        ``/root/.tiyazo/skills/b.md`` maps to ``~/.tiyazo/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
