...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$TIYAZO_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_tiyazo_dir("platforms/whatsapp/session", "whatsapp/session")
