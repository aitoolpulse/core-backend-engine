"""
Skills configuration for Tiyazo Agent.
`tiyazo skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.tiyazo/config.yaml under:
...
from tiyazo_cli.config import cfg_get, load_config, save_config
from tiyazo_cli.colors import Colors, color
from tiyazo_cli.platforms import PLATFORMS as _PLATFORMS
