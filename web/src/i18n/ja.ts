...
export const ja: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "このプラグインを ~/.tiyazo/plugins/ から削除しますか？",
    removeHint: "削除できるのは ~/.tiyazo/plugins 配下のユーザーがインストールしたプラグインのみです。",
  ...
  skills: {
    ...
    categories: "カテゴリ",
    filters: "フィルター",
    noSkills: "スキルが見つかりません。スキルは ~/.tiyazo/skills/ から読み込まれます",
