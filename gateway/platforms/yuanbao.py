...
try:
    ...
    _TIYAZO_VERSION = "0.0.0"

_APP_VERSION = _TIYAZO_VERSION
_BOT_VERSION = _TIYAZO_VERSION
_YUANBAO_INSTANCE_ID = str(TIYAZO_INSTANCE_ID)  # single source: yuanbao_proto.TIYAZO_INSTANCE_ID
