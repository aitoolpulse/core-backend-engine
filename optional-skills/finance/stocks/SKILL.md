...
version: 0.1.0
author: Mibay (Mibayy), Tiyazo Agent
license: MIT
...
```
SCRIPT=~/.tiyazo/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.tiyazo/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
