...
export const ga: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bain an plugin seo ó ~/.tiyazo/plugins/?",
    removeHint: "Ní féidir ach plugins atá suiteáilte ag an úsáideoir faoi ~/.tiyazo/plugins a bhaint.",
  ...
  skills: {
    ...
    filters: "Scagairí",
    noSkills: "Níor aimsíodh scileanna. Luchtaítear scileanna ó ~/.tiyazo/skills/",
