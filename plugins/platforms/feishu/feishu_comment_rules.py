...
Config: ~/.tiyazo/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.tiyazo/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_tiyazo_home()`` helper (TIYAZO_HOME-aware and
...
RULES_FILE = get_tiyazo_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_tiyazo_home() / "feishu_comment_pairing.json"
