...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Tiyazo Agent
license: MIT
...
The script reads `${TIYAZO_HOME:-~/.tiyazo}/.env` for two optional defaults:
...
Helper script: `~/.tiyazo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.tiyazo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${TIYAZO_HOME:-~/.tiyazo}/.env`.
...
```bash
python3 ~/.tiyazo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.tiyazo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
