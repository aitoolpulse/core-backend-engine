"""
Tiyazo MCP Server — expose messaging conversations as MCP tools.
...
Plus: channels_list (Tiyazo-specific extra)

Usage:
    tiyazo mcp serve
    tiyazo mcp serve --verbose
...
logger = logging.getLogger("tiyazo.mcp_serve")
...
class EventBridge:
    ...
    This is the Tiyazo equivalent of OpenClaw's WebSocket gateway bridge.
...
def create_mcp_server(event_bridge: Optional[EventBridge] = None) -> "FastMCP":
    """Create and return the Tiyazo MCP server with all tools registered."""
    ...
    mcp = FastMCP(
        "tiyazo",
        instructions=(
            "Tiyazo Agent messaging bridge. Use these tools to interact with "
...
def run_mcp_server(verbose: bool = False) -> None:
    """Start the Tiyazo MCP server on stdio."""
    if not _MCP_SERVER_AVAILABLE:
        print(
