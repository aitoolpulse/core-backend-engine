...
DEFAULT_UA = (
    "tiyazo-osint-investigation/0.2 "
    "(+https://github.com/aitoolpulse/core-backend-engine; "
    "set TIYAZO_OSINT_UA env var to identify yourself per "
...
def get(
    ...
    *,
    ...
    h = {"User-Agent": user_agent or os.environ.get("TIYAZO_OSINT_UA", DEFAULT_UA)}
    if headers:
        h.update(headers)
