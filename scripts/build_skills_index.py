#!/usr/bin/env python3
"""Build the Tiyazo Skills Index — a centralized JSON catalog of all skills.
...
`tiyazo skills search/install` can use it without hitting the GitHub API.
...
# Ensure TIYAZO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Tiyazo Skills Index...", flush=True)
