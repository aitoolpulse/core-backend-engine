# Streaming LLM Response Support for Tiyazo Agent
...
```
TIYAZO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("TIYAZO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `tiyazo_cli/config.py` | 1 | +streaming config defaults |
