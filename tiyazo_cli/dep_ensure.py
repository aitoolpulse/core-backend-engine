...
def _has_tiyazo_agent_browser() -> bool:
    ...
    # install.sh installs globally into $TIYAZO_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    run_env = tiyazo_subprocess_env(inherit_credentials=False)
