...
export const fr: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Retirer ce plugin de ~/.tiyazo/plugins/ ?",
    removeHint: "Seuls les plugins installés par l'utilisateur sous ~/.tiyazo/plugins peuvent être supprimés.",
  ...
  skills: {
    ...
    filters: "Filtres",
    noSkills: "Aucune compétence trouvée. Les compétences sont chargées depuis ~/.tiyazo/skills/",
