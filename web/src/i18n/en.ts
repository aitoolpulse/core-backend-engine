...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remove this plugin from ~/.tiyazo/plugins/?",
    removeHint: "Only user-installed plugins under ~/.tiyazo/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.tiyazo/skills/",
