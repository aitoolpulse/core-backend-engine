...
export const tr: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Bu eklenti ~/.tiyazo/plugins/ içinden kaldırılsın mı?",
    removeHint: "Yalnızca ~/.tiyazo/plugins altındaki kullanıcı tarafından yüklenmiş eklentiler kaldırılabilir.",
  ...
  skills: {
    ...
    filters: "Filtreler",
    noSkills: "Yetenek bulunamadı. Yetenekler ~/.tiyazo/skills/ adresinden yüklenir",
