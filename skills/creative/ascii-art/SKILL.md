...
```bash
python3 -m pyfiglet "TIYAZO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=TIYAZO&font=Slant" | boxes -d stone
```
