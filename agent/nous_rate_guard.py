...
(3 SDK retries x 3 Tiyazo retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_tiyazo_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".tiyazo")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Tiyazo, ...) behind one endpoint.  A 429 can mean either:
