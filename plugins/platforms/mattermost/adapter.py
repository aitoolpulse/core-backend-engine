...
required — uses aiohttp which is already a Tiyazo dependency.
...
def interactive_setup() -> None:
    ...
    ``tiyazo_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Tiyazo delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # tiyazo_cli/setup.py::_setup_mattermost function.
