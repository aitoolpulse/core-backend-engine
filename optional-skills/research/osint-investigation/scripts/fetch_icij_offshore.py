...
$HERMES_OSINT_CACHE/icij/ (default: ~/.cache/tiyazo-osint/icij/) and search
...
def main() -> int:
    ...
    p.add_argument(
        ...
        type=Path,
        default=None,
        help="Override cache directory (default: $HERMES_OSINT_CACHE/icij or ~/.cache/tiyazo-osint/icij)",
    )
    p.add_argument(
        "--force-refresh",
        action="store_true",
