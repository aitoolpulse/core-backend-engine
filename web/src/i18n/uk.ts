...
export const uk: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Видалити цей плагін з ~/.tiyazo/plugins/?",
    removeHint: "Видаляти можна лише плагіни, встановлені користувачем у ~/.tiyazo/plugins.",
  ...
  skills: {
    ...
    filters: "Фільтри",
    noSkills: "Навичок не знайдено. Навички завантажуються з ~/.tiyazo/skills/",
