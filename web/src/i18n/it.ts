...
export const it: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Rimuovere questo plugin da ~/.tiyazo/plugins/?",
    removeHint: "Solo i plugin installati dall'utente in ~/.tiyazo/plugins possono essere rimossi.",
  ...
  skills: {
    ...
    filters: "Filtri",
    noSkills: "Nessuna competenza trovata. Le competenze vengono caricate da ~/.tiyazo/skills/",
