"""Vertex AI (Google Cloud) adapter for Tiyazo Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Tiyazo to use Gemini models via Google Cloud with
...
# who installed plain `tiyazo-agent` and only later selected a Gemini model.
try:
