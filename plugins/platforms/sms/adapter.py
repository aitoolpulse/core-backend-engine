...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Tiyazo gateway adapter.

    Each inbound phone number gets its own Tiyazo session (multi-tenant).
...
# static dict in tiyazo_cli/gateway.py, and the _send_sms dispatch in
