...
def auth_json_path():
    """Return the Tiyazo auth store path, respecting TIYAZO_HOME overrides."""
    return get_tiyazo_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`tiyazo tools`, banner/status paint, provider
