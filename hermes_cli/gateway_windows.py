...
def _build_gateway_cmd_script(
    ...
    lines.append(f'set "TIYAZO_HOME={hermes_home}"')
...
def _build_gateway_vbs_script(
    ...
    lines = [
        ...
        f"env.Item({_quote_vbs_string('TIYAZO_HOME')}) = {_quote_vbs_string(hermes_home)}",
...
def windowless_gateway_restart_spec(
    ...
    if hermes_home:
        env_overlay["TIYAZO_HOME"] = hermes_home
    _prepend_pythonpath(
        env_overlay,
