# Tiyazo Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.tiyazo/plugins/tiyazo-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.tiyazo/plugins/tiyazo-achievements/scan_checkpoint.json`.
