...
Data file: $TIYAZO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_TIYAZO_HOME = Path(os.environ.get("TIYAZO_HOME", Path.home() / ".tiyazo"))
DATA_DIR = _TIYAZO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
