...
export const hu: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Eltávolítja ezt a bővítményt a ~/.tiyazo/plugins/ mappából?",
    removeHint: "Csak a felhasználó által a ~/.tiyazo/plugins alá telepített bővítmények távolíthatók el.",
  ...
  skills: {
    ...
    filters: "Szűrők",
    noSkills: "Nem található készség. A készségek a ~/.tiyazo/skills/ mappából töltődnek be",
