...
export const es: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "¿Eliminar este complemento de ~/.tiyazo/plugins/?",
    removeHint: "Solo se pueden eliminar complementos instalados por el usuario en ~/.tiyazo/plugins.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "No se encontraron habilidades. Las habilidades se cargan desde ~/.tiyazo/skills/",
