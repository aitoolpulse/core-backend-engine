...
TIPS = [
    ...
    "Hermes loads project context from .tiyazo.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "Profiles scope Hermes state via TIYAZO_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    'HERMES_ENABLE_PROJECT_PLUGINS=1 auto-loads repo-local plugins from ./.tiyazo/plugins/ — trust-gated by design.',
