...
Trust levels:
  - builtin:   Ships with Tiyazo. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.tiyazo/\.env|\~/\.tiyazo/\.env',
     ...
     "directly references Tiyazo secrets file"),
    ...
    (r'\.tiyazo/config\.yaml|\.tiyazo/SOUL\.md',
     ...
     "references Tiyazo configuration files directly"),
...
# scan. `.skillignore` is the Tiyazo-native name; `.clawhubignore` is honored
