...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Tiyazo's web-provider config and
        ...
        # native search engine for xAI sessions instead of Tiyazo's
        # configured web provider (Tavily/etc.), and those results bypass
        # Tiyazo's tool-trace / citation plumbing (they arrive baked into the
