...
4. Name the token (e.g., "Tiyazo Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${TIYAZO_HOME:-~/.tiyazo}/.env`:
...
```bash
CANVAS="python $TIYAZO_HOME/skills/productivity/canvas/scripts/canvas_api.py"
