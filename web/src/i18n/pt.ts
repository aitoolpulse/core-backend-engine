...
export const pt: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Remover este plugin de ~/.tiyazo/plugins/?",
    removeHint: "Apenas plugins instalados pelo utilizador em ~/.tiyazo/plugins podem ser removidos.",
  ...
  skills: {
    ...
    filters: "Filtros",
    noSkills: "Nenhuma competência encontrada. As competências são carregadas de ~/.tiyazo/skills/",
