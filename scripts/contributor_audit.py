...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Tiyazo\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "tiyazo@nousresearch.com",
    "tiyazo-audit@example.com",
    "tiyazo@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "aitoolpulse/core-backend-engine",
                "--state", "merged",
