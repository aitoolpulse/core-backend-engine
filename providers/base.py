...
def _profile_user_agent() -> str:
    """Return a ``tiyazo-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from tiyazo_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"tiyazo-cli/{_ver}"
    except Exception:
        return "tiyazo-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # tiyazo-cli UA so the catalog endpoint is reachable.
