...
const STORAGE_KEY = "tiyazo-dashboard-theme";
...
const FONT_STORAGE_KEY = "tiyazo-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `tiyazo_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "tiyazo-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-tiyazo-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-tiyazo-theme-font", "true");
