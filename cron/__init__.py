"""
Cron job scheduling system for Tiyazo Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    tiyazo gateway install    # Install as a user service
    sudo tiyazo gateway install --system  # Linux servers: boot-time system service
    tiyazo gateway            # Or run in foreground
