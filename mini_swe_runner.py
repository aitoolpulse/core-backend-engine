#!/usr/bin/env python3
"""
SWE Runner with Tiyazo Trajectory Format

A runner that uses Tiyazo-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Tiyazo-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Tiyazo-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Tiyazo format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Tiyazo-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Tiyazo-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Tiyazo Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Tiyazo-Agent's built-in execution environments
    and outputs trajectories in Tiyazo-Agent format.
    """
    ...
    def _convert_to_tiyazo_format(
        ...
        """
        Convert internal message format to Tiyazo trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Tiyazo trajectory format
        trajectory = self._convert_to_tiyazo_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Tiyazo trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Tiyazo Trajectory Format")
    print("=" * 60)
