#!/usr/bin/env python3
"""Build the Tiyazo Model Catalog — a centralized JSON manifest of curated models.
...
Tiyazo CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Tiyazo release.
...
# Ensure TIYAZO_HOME is set for imports that touch it at module level.
os.environ.setdefault("TIYAZO_HOME", os.path.join(os.path.expanduser("~"), ".tiyazo"))

from tiyazo_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "tiyazo-agent repo",
            "docs": "https://tiyazo-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
