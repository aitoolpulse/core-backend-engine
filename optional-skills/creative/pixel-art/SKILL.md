...
```python
import sys
sys.path.insert(0, "/home/teknium/.tiyazo/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.tiyazo/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Tiyazo installs package this)
