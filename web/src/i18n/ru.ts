...
export const ru: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Удалить этот плагин из ~/.tiyazo/plugins/?",
    removeHint: "Удалять можно только плагины, установленные пользователем в ~/.tiyazo/plugins.",
  ...
  skills: {
    ...
    filters: "Фильтры",
    noSkills: "Навыки не найдены. Навыки загружаются из ~/.tiyazo/skills/",
