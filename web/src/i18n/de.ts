...
export const de: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Dieses Plugin aus ~/.tiyazo/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.tiyazo/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.tiyazo/skills/ geladen",
