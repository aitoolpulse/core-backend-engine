...
author: Tiyazo Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  tiyazo:
...
# $TIYAZO_OSINT_CACHE/icij/ (default: ~/.cache/tiyazo-osint/icij/).
...
# Set TIYAZO_OSINT_UA=your-app/1.0 (your@email) to identify yourself
