...
```bash
git clone https://github.com/PCinkusz/hermes-achievements ~/.tiyazo/plugins/hermes-achievements
```
...
ln -s ~/hermes-achievements ~/.tiyazo/plugins/hermes-achievements
```
...
```bash
cd ~/.tiyazo/plugins/hermes-achievements
git pull --ff-only
curl http://127.0.0.1:9119/api/dashboard/plugins/rescan
```
