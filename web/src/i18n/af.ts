...
export const af: Translations = {
  ...
  pluginsPage: {
    ...
    removeConfirm: "Verwyder hierdie inprop uit ~/.tiyazo/plugins/?",
    removeHint: "Slegs gebruiker-geïnstalleerde inproppe onder ~/.tiyazo/plugins kan verwyder word.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "Geen vaardighede gevind nie. Vaardighede word gelaai uit ~/.tiyazo/skills/",
